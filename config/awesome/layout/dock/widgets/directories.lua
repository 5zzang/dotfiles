...
local directories = {
	...
	downloads = create_button('folder-downloads.svg', '~/Downloads/', 2, 0, 0, 2),
	documents = create_button('folder-documents.svg', '~/Documents/', 2, 0, 0, 2),
	config = create_button('folder-development.svg', '~/.config', 2, 0, 0, 2),
}
